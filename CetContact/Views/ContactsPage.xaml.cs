...
public partial class ContactsPage : ContentPage
{
    ...
    private async void SearchBarContacts_TextChanged(object sender, TextChangedEventArgs e)
    {
        var keyword = e.NewTextValue.ToLower();
        var filteredContacts = await contactRepository.SearchContacts(keyword);
